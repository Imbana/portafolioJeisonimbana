...
import { faReact, faCss3Alt,faHtml5,faSass,faJs,faBootstrap, faGitAlt, faGithub,faPython,} from "@fortawesome/free-brands-svg-icons";
...
const ListaSkills = [
  { id: "1", value: "React", icon: faReact, link: "https://es.reactjs.org/" },
  {
    id: "2",
    value: "Css",
    icon: faCss3Alt,
  ...
  { id: "9", value: "Python", icon: faPython, link: "https://www.python.org/" },
];
            ...
            <div className="aboutRight">
              <div className="aboutRightContain">
                ...
                <h3 className="aboutRightFirst">
                  Yo soy Jeison Imbaña Ingeniero electrónico,apasionado a la
                  tecnología, desarrollo web e inteligencia Artificial{" "}
                </h3>
                <p className="aboutRightText">
                  Poseo conocimiento en reparación y mantenimiento de equipos
                  electrónicos, diseño y construcción de paginas web
                  principalmente con la librería React, ademas cuentos con
                  habilidades en programación de python orientado a
                  procesamiento de datos y redes neuronales. Capacidad de
                  adaptabilidad, mejoramiento continuo y abierto a adquirir
                  nuevos conocimientos en diferentes áreas de la ingeniería.
                </p>
                <a
                  className="download"
